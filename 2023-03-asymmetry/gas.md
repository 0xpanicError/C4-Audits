...
### <a name="GAS-1"></a>[GAS-1] Intialise non-zero variables at the time of declaration
...
### <a name="GAS-2"></a>[GAS-2] Cache array length in memory when called in loops
...
### <a name="GAS-3"></a>[GAS-3] If value is read only once, load directly from storage
...
### <a name="GAS-4"></a>[GAS-4] No need to loop to add or adjust totalWeight
